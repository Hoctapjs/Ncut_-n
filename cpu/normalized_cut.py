...
def normalized_cut_segmentation(image_path, num_segments=2):
    """
...
if __name__ == "__main__":
    image_path = "apple.jpg"  # Đường dẫn đến ảnh của bạn
    num_segments = 3  # Số vùng cần phân đoạn
    
    print("Bắt đầu phân đoạn ảnh...")
    segmented_image = normalized_cut_segmentation(image_path, num_segments)
