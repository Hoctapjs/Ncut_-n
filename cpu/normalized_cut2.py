...
def construct_graph(image, sigma_color=0.1, sigma_spatial=10):
    """
...
if __name__ == "__main__":
    ...
    scale = 0.1  # Giảm kích thước ảnh xuống 50%
    
    print("Bắt đầu phân đoạn ảnh...")
    segmented_image = normalized_cut_segmentation(image_path, num_segments, scale)
